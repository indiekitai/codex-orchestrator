...
这是原来放在根 README 里的详细说明。根 README 现在刻意保持简短、面向人类读者；
本文件保留更深的工作流、routine、配置和参考材料，供 Codex App 和高级用户阅读。
...
[TastyFuture 案例](case-studies/tastyfuture-orchestration.md)、以及
[案例文章](articles/tastyfuture-loop-engineering-case.md)。
