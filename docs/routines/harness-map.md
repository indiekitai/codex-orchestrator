...
| Budget policy | Routine budget metadata, ledger timestamps, heartbeat budget report, static report fixture | Local/static budget summary, pressure warnings, unknown timing flags, metadata coverage summary | Report only; do not schedule, prioritize, enforce, dispatch, pause, kill, or control workers |
