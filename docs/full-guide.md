[Home](../README.md) | [中文完整指南](full-guide.zh-CN.md)

# Full Guide

This is the detailed guide that used to live in the root README. The root
README is intentionally shorter and human-facing; this file keeps the deeper
workflow, routine, configuration, and reference material for Codex App and
advanced users.
...
[docs/beta-usability-package.md](beta-usability-package.md) before running
...
See [docs/v2-persistent-ledger-and-heartbeat.md](v2-persistent-ledger-and-heartbeat.md)
for the v2 durable ledger and heartbeat helper design, and
[docs/v2-usage.md](v2-usage.md) for the Codex App + Go helper workflow.
See [docs/routines/README.md](routines/README.md) for the v2.5 routine
contract format and [docs/routines/harness-map.md](routines/harness-map.md)
for the feedback-loop harness model.
For a first-time external-user path from install to a safe local demo, see
[docs/beta-usability-package.md](beta-usability-package.md). For release
copy, see [docs/beta-release-notes-draft.md](beta-release-notes-draft.md).
...
For the broader roadmap, see [docs/roadmap.md](roadmap.md).
