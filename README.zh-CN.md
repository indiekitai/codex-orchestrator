...
**睡一觉，好几个功能都写好了。** 这是一个 [OpenAI Codex App](https://chatgpt.com/codex) 的多会话编排 skill，能连续从路线图中选功能——每个功能拆成多个并行 worktree 会话，5 分钟巡检一次，跑完的自动验收合并，卡住超 15 分钟但已有可用 commit 的直接审查合并不傻等，做完一个功能自动选下一个继续。你可以安心去睡觉，醒来看到的是多个功能合并好的分支。
